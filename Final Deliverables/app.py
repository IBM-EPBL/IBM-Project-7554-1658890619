...
def send_confirmation_mail( email):
    ...
    from_email = Email("varshathiru01@gmail.com")
    to_email = To(email)
    subject = "Welcome to Nutroscan"
    content = Content("text/plain","Nutroscan helps you to identify your food items nutritional values.It provide you with detailed plans and by uploading images you can identify your nutritional values.")
